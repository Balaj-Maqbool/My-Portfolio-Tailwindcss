        ...
        <section id='hero' className={` min-h-screen min-w-screen z-50 md:min-h-screen  flex flex-col flex-center md:flex-row `}>
            ...
            <div className=' min-h-screen  min-w-screen pb-32 z-10 md:pb-10 md:py-0  flex flex-col flex-center space-y-3 '>
                ...
                <div className='w-full text-[.7rem] lg:text-[1rem] xl:text-[1.1rem] text-center text-text'>
                    <p className='animate-fade-in-delay-4 opacity-[.9] font-sans'>
                    ...
                    <p className='animate-fade-in-delay-5 opacity-[.9] font-normal '>
                    ...
                    <p className='animate-fade-in-delay-6 opacity-[.9] font-sans'>

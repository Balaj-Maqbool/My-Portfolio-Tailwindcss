    ...
    return (
        <section id='projects' className={`min-h-screen  p-5 relative  pt-20 z-50`}>
            ...
            <div className='w-full text-[0.82rem] md:text-[.9rem] my-5 space-y-1 opacity-90  xl:text-[1rem] text-center gradient-text-grey'>
                ...
                <p className='sm:hidden'>A glimpse of <strong className='gradient-text-pink font-normal' >real-world projects</strong> where ideas meet <strong className='gradient-text-pink font-normal'>clean code</strong> and <strong className='gradient-text-pink font-normal'>great design</strong>. <span className=''>Planed and built with <strong className='gradient-text-pink font-normal'>precision</strong>, <strong className='gradient-text-pink font-normal'>passion</strong>, and <strong className='gradient-text-pink font-normal'>purpose</strong>.</span></p>

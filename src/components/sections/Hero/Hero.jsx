        ...
        <section id='hero' className={` min-h-screen min-w-screen z-50   flex flex-col flex-center md:flex-row `}>
            ...
            <div className='flex  flex-center bg-transparent  w-full  sm:py-3 md:py-15 max-sm:pb-0  md:min-h-screen md:min-w-[40%]'>
                <img ref={pictureRef}
                    ...
                    decoding='asyn'
                    loading='eager'
                    aria-label='Balaj Maqbool Profile'
                    alt="Balaj Maqbool Profile Pic"
                    className={`${pictureIsVisible ? "will-change-[transform,opacity] animate-when-visible" : " will-change-auto animate-when-invisible"} transition-all duration-700 ease-in-out profile-image object-cover bg-transparent`}>
                </img>
            </div>

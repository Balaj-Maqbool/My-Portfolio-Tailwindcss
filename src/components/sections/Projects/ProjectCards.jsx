    ...
    return (
        ...
        >
            ...
            <div className='w-full flex px-3 pb-3 space-x-2.5'>
                <a className='project-links' href={project.githubURL} aria-label={` ${project.title} GitHub Link`} target='_blank' rel="noopener noreferrer">
                    <Github aria-hidden='true' size={20} />
                </a>
                <a className='project-links' href={project.liveURL} aria-label={` ${project.title} Deployment Link`} target='_blank' rel="noopener noreferrer">

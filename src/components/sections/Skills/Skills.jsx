...
const Skills = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-4  sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 px-0 sm:px-5 sm2:px-10 xl:grid-cols-5 lg:px-24 md:py-5 lg:py-10 max-sm:gap-y-5 gap-2 sm:gap-5 md:gap-7 lg:gap-10">

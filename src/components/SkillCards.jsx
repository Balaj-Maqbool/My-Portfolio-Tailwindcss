...
const SkillCards = ({ skill }) => {
    ...
    return (
        <div ref={ref} className={` ${isVisible ? "scale-100 opacity-100" : "scale-0 opacity-0"} rounded-xs z-50  bg-project ring-1 ring-primary/80   p-3 px- lg:p-3.5 sm:p-2.5  w-full  hover:scale-110 transition-all ease-in-out duration-500 animate-scale-out`}>

...
const SectionHeading = ({ p1, p2 }) => {
    ...
    return (
        ...
        <h2
            ref={ref}
            className={`${isVisible ? "will-change-[transform,opacity] opacity-100 scale-100" : " will-change-auto opacity-0 scale-0 "} transition-all duration-1000 ease-in-out text-center text-[1.4rem] sm:text-2xl md:text-3xl lg:text-4xl  tracking-wide`}
        >

...
const Projects = () => {
    ...
    return (
        <section id='projects' className={`min-h-screen  p-5 relative  pt-20 z-50`}>
            ...
            <div ref={ref} className={`${isVisible ? "scale-100 opacity-100 " : "opacity-0 scale-0"} transition-all ease-in-out duration-1000 w-full text-[0.82rem] md:text-[.9rem] my-5 space-y-1  xl:text-[1rem] text-center gradient-text-grey`}>

...
const ProjectCard = ({ project }) => {
    ...
    return (
        <div ref={ref} className={`flex flex-col ring-accent active:ring-1 hover:ring-1 hover:scale-[1.03] active:scale-105 transition-all ease-in-out duration-500  z-100   rounded-md  bg-blue-600/10 `}>
